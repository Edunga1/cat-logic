...
[https://www.youtube.com/playlist?list=PLo6lBZn6hgca1T7cNZXpiq4q395ljbEI_](https://www.youtube.com/playlist?list=PLo6lBZn6hgca1T7cNZXpiq4q395ljbEI_)

단계적으로 2D 물리 알고리즘을 구현하는 플레이리스트.
[javascript](./javascript.md) 및 canvas로 구현한다.
...
속도 velocity, 질량 mass, 탄성 elasticity, 마찰 friction, 가속도 acceleration 요소를 고려하여 충돌 계산한다.
