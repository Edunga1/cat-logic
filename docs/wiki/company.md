...
2024년에는 신규 게임인 path of exile 2를 개발 중이다.
유료 상품이 기존 게임과 연동된다. 유료 상품과 플랫폼 통합을 위한 마이그레이션 작업으로 공개가 지연되었다.
재밌는 점은 상세한 내용을 공지사항에 공개하였다는 점이다.
...
이 공지사항의 댓글 반응은 대체로 긍정적이다.
어떤 일이 있었는지 투명하게 공개해서 고맙다는 반응이다.
