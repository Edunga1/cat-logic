...
2025년 4월, 2025.1 버전 출시와 함께 [All Products Pack 라이센스에 JetBrains AI가 포함](https://sales.jetbrains.com/hc/en-gb/articles/16544922728466)된다.
...
Spring Bean은 프레임워크에 의해 생성 및 주입되기 때문에, IDE가 unused라고 표시한다.
