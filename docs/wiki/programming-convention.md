...
사용하려면:
* [javascript](javascript)의 경우 `new Date().toJSON()`: `"2020-07-10T02:42:55.338Z"`
* [python](python)의 경우 `datetime.now().isoformat()`: `'2020-07-10T02:43:36.933276'`

[python](python)의 경우 시간대 지정자 `Z`가 생략되었다.
